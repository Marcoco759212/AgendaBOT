import { BarChart3, CalendarDays, CreditCard, Settings2, Users, WalletCards } from 'lucide-react'
...
const navigation = [
  ...
  { key: 'settings', label: 'Configuración del Bot & WhatsApp', icon: Settings2 },
...
function Sidebar({ onNavigate }: { onNavigate?: (view: ViewName) => void }) {
  ...
  const visibleNavigation = navigation.filter((item) => item.key !== 'team' || activeTenantRole === 'owner')
